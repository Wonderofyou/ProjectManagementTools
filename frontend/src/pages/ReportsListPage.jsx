    ...
    <div className="max-w-full px-12 py-8 bg-white rounded-lg shadow-lg">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        {projects.map((project) => (
          ...
          >
            <h2 className="text-2xl font-semibold text-gray-800">{project.project_id.name}</h2>
            ...
            <div className="mt-4">
              ...
              <p className="text-sm text-gray-600 mt-1">{project.project_id.progress}% completed</p>
            </div>
